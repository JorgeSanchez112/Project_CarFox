...
cantidad decimal (5) not null,
nombre_proveedor text (50) not null
);
...
costo_visualizado double not null, /*apartir de aqui hasta que termine esta tabla son los campo que se van a relacionar*/
...
descripcion_de_reparacion varchar (110) not null,
Registro_fotografico_cp blob not null,
costo_total double not null, /*apartir de aqui hasta que termine esta tabla son los campo que se van a relacionar*/
fk_documento int (2) not null,
fk_id_usuario varchar (20) not null,
...
values (1,"¿Cual fue el nombre de su primera mascota?");

/* #3 usuarios */

insert into usuarios
values ("1067219831","1","Juan ","Jose","Florez","Ruiz","123",1);

insert into usuarios
values ("1327890191","2","Fernando ","null","Dias","Alvarez","345",1),
("1067256745","1","Luisa","Fernanda","Gomez","null","567",1),
("1297639521","1","Duban","Santiago","Mojica","null","789",1),
("1902378252","2","Emily","anastasia","Sanchez","Beltran","101a",1);
...
values ("1","1067219831",1,1);

insert into usuario_rol
values ("2","1327890191",2,1),
("1","1067256745",2,1),
("1","1297639521",2,1),
("2","1902378252",2,1);
...
values (1,"Llantas",45,"Proveedor 1");

insert into repuestos
values (2,"Farolas",34,"Proveedor 2"),
(3,"Cambio de pintura",96,"Proveedor 3"),
(4,"aceite",74,"Proveedor 4"),
(5,"Cambio de farolas",84,"Proveedor 5");
...
values (1,"foto_1.jpg","Cambio de llantas","14:15","2022-09-03",50000,"1","1067219831","DTE312");

insert into check_in
values (2,"foto_2.png","Cambio de frenos","15:20","2021-06-10",50000,"2","1327890191","CZR263"),
(3,"foto_3.png","Cambio de bateria","17:00","2019-03-11",100000,"1","1067256745","AOP567"),
(4,"foto_4.jpg","Cambio de las escobillas limpia parabrizas","17:30","2019-04-09",20000,"1","1297639521","MSP206"),
(5,"foto_5.png","Cambio de farolas","16:00","2018-05-12",25000,"2","1902378252","SQW954");

/* #11 check_up */

insert into check_up
values (1,"15:15","2022-03-09","Automovil color blanco se encuentra con una llanta dañada, necesitando un cambio de llanta.","foto_1.jpg",50000,"1","1067219831",1,1);

insert into check_up
values (2, "15:50", "2021-06-11", "Se le realizo el respectivo cambio de llantas con los repuestos que se ingresaron y con herramientas utilizadas","foto_2.jpg",50000,"2","1327890191",2,2),

(3, "19:50", "2019-03-12", "Al automovil se le realizo un cambio de bateria con herramientas mecanicas","foto_3.jpg",100000, "1","1067256745",3,3),

(4, "18:14", "2019-04-09", "Se le implementaron nuevas escobillas al parabrizas con herramientsa manuales","foto_4.jpg",20000,"1","1297639521",4,4),

(5, "16:50", "2018-05-13", "Se retiraron las farolas antiguas y se implementaron nuevas  con herramientas manuales","foto_5.jpg",25000,"2","1902378252",5,5);
...
select * from insumos ;
select * from camb_contra ;
select * from check_in;
select * from check_up ;
select * from herramientas ;
select * from propietario_auto ;
select * from reporte ;
