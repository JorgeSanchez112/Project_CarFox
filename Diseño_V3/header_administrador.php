            ...
            <div class="menu-left">
                ...
                <section class="section__aside" id="aside">
                    ...
                    <ul class="lista">
                        ...
                        <li><a href="neg_dat_consultar_repuesto.php"><i class="fa-solid fa-hammer"></i> Repuestos</a></li>
                        <li><a href="neg_dat_consultar_historial.php"><i class="fa-solid fa-scroll"></i> Historial</a></li>
                        <li><a href="salir.php "><i class="fa-solid fa-right-to-bracket"></i> Cerrar sesión</a></li>
                    </ul>
                </section>
            </div>    
            <nav class="nav__user">
                <h2> Bienvenido señor/a (Variable user) </h2>
            <nav>
        </header>
    </body>
</html>