    ...
    <main>
        ...
        <section class="container">
            ...
            <article class="box box-3">
                ...
                <div>
                    <p>Vehiculo</p>
                    <a href="pres_registro_vehiculos.php">Registrar vehiculo</a>
                </div>
            </article>
            <article class="box box-4">
                ...
                <div>
                    <p>Empleado</p>
                    <a href="pres_registro_empleados.php">Registrar empleado</a>
                </div>
            </article>
            <article class="box box-5">
                ...
                <div>
                    <p>Observacion</p>
                    <a href="pres_registro_observaciones.php">Registrar observacion</a>
                </div>
            </article>
        </section>
    </main>
