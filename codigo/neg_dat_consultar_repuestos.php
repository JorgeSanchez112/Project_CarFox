...
<?php include('header_administrador.php');?>
        ...
        while ($row=$result->fetch_assoc()):
            ...
            echo "<tr>";
                ...
                echo "<td data-label='Eliminar'>";
                    echo "<form method='POST' action='neg_dat_eliminar_repuestos.php'>";
                    echo "<input type= 'hidden' class='barra' name = 'id_repuesto' Value='$id_repuesto'>";
    ...
    ?>      
        <a class="btn_bottom" href="pres_registro_repuestos.php">Nuevo Repuesto</a>
    </main>
</body>
</html>