        ...
        public function actualizar($id_entrada)
        {
            ...
            echo "<section class='container'>";
                ...
                echo "<article class='article__container-form'>";
                    echo "<form method='POST' action='neg_dat_actualizar_entrada_vehiculo.php' enctype='multipart/form-data'>";
                        ...
                        echo "<input type='datetime-local' name='fecha_entrada' id='fecha_entrada' value='$fecha_entradad' required>";
                        echo "<a class='btn__actualizar-imagen' href='pres_neg_dat_actualizar_imagen_entrada_vehiculo.php?id_entrada=$id_entradad&nombre=$nombre_imgd'>Actualizar imagen</a>";
