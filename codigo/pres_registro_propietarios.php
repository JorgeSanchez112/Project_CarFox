        ...
        <section class="container">
            ...
            <article class="article__container-form">
                <form method="POST" action="neg_dat_registro_propietarios.php">
                    ...
                    <input type="text" id="nombre" name="nombres" placeholder="Ingresar nombre" maxlength="45">
                    <label for="apellido">Apellidos de propietario</label>
                    <input type="text" id="apellido" name="apellidos" placeholder="Ingresar apellido" maxlength="45">
