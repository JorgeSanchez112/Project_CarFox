...
<?php include('header_administrador.php');?>
        ...
        while ($row=$result->fetch_assoc()):
            ...
            echo "<tr>";
                ...
                echo "<td data-label='Actualizar'>";
                    echo "<form method='POST' action='pres_neg_dat_actualizar_propietarios.php'>";
                ...
                echo "<td data-label='Eliminar'>";
                    echo "<form method='POST' action='neg_dat_eliminar_propietarios.php'>";
                    echo "<input type= 'hidden' class='barra' name = 'id_propietario' Value='$id_propietario'>";
    ...
    ?>      
        <a class="btn_bottom" href="pres_registro_propietarios.php">Nuevo propietario</a>
    </main>
</body>
</html>