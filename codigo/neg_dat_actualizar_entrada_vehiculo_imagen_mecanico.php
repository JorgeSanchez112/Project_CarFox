...
{  
	public function actualizar_imagen($id_entrada,$nombre)
	{
		...
		if (move_uploaded_file($_FILES['file']['tmp_name'][0],$destino.'/'.$imagenfinal)){	
			mysqli_query($db,"UPDATE entrada_vehiculo SET imagenes_entrada='$imagenfinal' WHERE id_entrada='$id_entrada'");
		}
...
$nuevo->actualizar_imagen($_POST["id_entrada"],$_POST["nombre"]);
