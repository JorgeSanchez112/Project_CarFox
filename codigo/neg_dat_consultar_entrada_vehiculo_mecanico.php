...
<?php include('header_mecanico.php');?>
        ...
        while ($row=$result->fetch_assoc()):
            ...
            echo "<tr>";
                ...
                echo "<td data-label='Actualizar'>";
                    echo "<form name='shdhd' method='POST' action='pres_neg_dat_actualizar_entrada_vehiculo_mecanico.php'>";
    ...
    ?>      
        <a class="btn_bottom" href="pres_registro_entrada_vehiculo_mecanico.php">Nueva entrada de vehiculo</a>
    </main>
</body>
</html>